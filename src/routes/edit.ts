          ...
          services.BookService.getUserBookInfo(
            ...
            (userBookInfo) => {
              if (userId === userBookInfo.id) {
                services.BookService.getBookInfo(
                  req.params.bookId,
                  (bookInfo) => {
                    services.DepartmentService.getDepartments(
                      (departments) => {
                        services.ConditionService.getConditions(
                          (conditions) => {
                ...
                renderPage(req, res, "unable-to-edit", {
